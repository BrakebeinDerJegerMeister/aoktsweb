...
import { ScenarioStructs } from './scenario.js';
...
class BufferIO {
    ...
    constructor (arrayBuffer, sectionMap) {
        ...
        console.log(sectionMap.triggers);
        //console.log(sectionMap)
    }
...
class ScenarioIO {
    ...
    constructor (arrayBuffer, ext, version) {
        ...
        let scenario = new ScenarioStructs(ext, version);

        let dv = (function () {
            let _dataView = new DataView(arrayBuffer);
            let _currentIndex = 0;
            return new class {
                get dataView() { return _dataView; }
                get currentIndex() { return _currentIndex; }
                jump(n) { _currentIndex += n }
            }();
        })()
        ...
        let uncompressedScenarioInstance = new scenario.uncompressedHeader.type(dv, scenario.uncompressedHeader);
        uncompressedScenarioInstance.read();
        ...
        console.log(compressedDataInstance.triggers)
